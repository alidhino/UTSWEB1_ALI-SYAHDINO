...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($jumlah === '' || !is_numeric($jumlah) || $jumlah <= 0) $errors[] = "Jumlah tidak valid.";
    if (empty($errors)) {
        // Normalisasi tipe
        $harga = (int) $harga;
        $jumlah = (int) $jumlah;
        ...
        <main class="card">
            ...
            <form method="post" novalidate>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" placeholder="Masukkan Nama Barang" required readonly>
                </div>
                <div class="form-group">
                    <label for="harga">Harga</label>
                    <input type="number" id="harga" name="harga" placeholder="Masukkan Harga" min="0" required readonly>
                </div>
                <div class="form-group">
                ...
                <table aria-label="Daftar Pembelian">
                    ...
                    <tbody>
                        ...
                        <tr class="total-row">
                            ...
                            <td class="right">Rp <?php echo number_format($grandtotal, 0, ',', '.'); ?></td>
                        </tr>
                        <tr class="total-row">
                            <td colspan="3"></td>
                            <td class="right">Diskon</td>
                            <td class="right">Rp <?php echo number_format($diskon, 0, ',', '.'); ?> (<?php echo htmlspecialchars($d); ?>)</td>
                        </tr>
                        <tr class="total-row">
                            <td colspan="3"></td>
                            <td class="right">Total Bayar</td>
                            <td class="right">Rp <?php echo number_format($totalbayar, 0, ',', '.'); ?></td>
                        </tr>
                    </tbody>
                </table>
...
<script>
    ...
    kodeSelect.addEventListener('change', function() {
        ...
        if (barangData[selectedKode]) {
            ...
            // Set readonly untuk mencegah perubahan manual
